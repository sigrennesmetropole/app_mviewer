var printMap = (function () {
  ...
  var createPrintWindow = function (pictureSrc) {
    ...
    var printPage =
      '<div id="printPage"> <div id="mapLegend"><label>Légende</label><div class="legendContainer">' +
      legend +
      "</div></div>" +
      '<div id="mapToPrint" class="mapToPrint">' +
      '<img id="exportMap" class="exportMap fit-picture" src="' +
      pictureSrc +
      '" alt="carte à imprimer">' +
      "</div>" +
    ...
    printWindow.document.write(
      "<html><head><title>Impression de votre plan</title>",
    );
    printWindow.document.write(
      '<link rel="stylesheet" href="apps/public/css/printMap.css" type="text/css" />',
    );
    printWindow.document.write(
