...
function _adjustLegend() {
  ...
  $("#layers-container .layerdisplay-titleLabel>i.mv-grip").replaceWith(
    '<i class="state-icon ri-arrow-down-s-line" onclick="mviewer.toggleLayerOptions(this);"></i>',
  );
  $("#layers-container .layerdisplay-title>a:not(.mv-layer-remove)").attr(
    "onClick",
    "mviewer.toggleLayerOptions(this);",
  );

  $("#layers-container .layerdisplay-title>a:not(.mv-layer-remove)").on(
    "click",
    function () {
      _switchchevron($(this));
    },
  );
  $("#layers-container .layerdisplay-titleLabel>i.state-icon").on(
    "click",
    function () {
      _switchchevron($(this));
    },
