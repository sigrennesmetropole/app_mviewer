mviewer.customLayers.dircove_autres = (function () {
  let _flux =
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=eq_autres:fonds_concours_dircove&outputFormat=application/json&srsName=EPSG:3857";
  let _filtre_data = encodeURI(
    "nature_equipement='2 - Autres projets - Equipements Batimentaire et non batimentaire'",
  );
    ...
    xhr.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        _g.setAttributeNS(
          null,
          "transform",
          "matrix(0.1493328,-0.06033437,0.05884351,0.14564281,46.023617,11.313834)",
        );
