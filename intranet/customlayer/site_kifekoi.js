mviewer.customLayers.site_kifekoi = (function () {
  let data_url =
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=eq_poi:v_sitorg_site&outputFormat=application/json&srsName=EPSG:3857";
  ...
  function _getURL() {
    ...
    if (idsite != undefined && idsite.trim() != "") {
      ...
      var url =
        data_url +
        "&cql_filter=etat_site=%27actif%27%20AND%20id_site=" +
        idsite;
      return url;
