{
    ...
    cl.legend.items.push({styles:uniqueStyle, label: "Entreprise", geometry: "Point"});
    ...
    cl.legend.items.push({styles:manyStyle(10,10,7), label: "Groupe d'entreprises", geometry: "Point"});
