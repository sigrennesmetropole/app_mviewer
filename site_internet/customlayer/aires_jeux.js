mviewer.customLayers.aires_jeux_rennes = (function () {
  ...
  let pointOnSurfaceMarker =
    "apps/site_internet/customlayer/picture/aire_de_jeux.svg";

  let data_url =
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=espub_mob:gev_ajeu&outputFormat=application/json&srsName=EPSG:3857";
  ...
  function _updateStyle() {
    ...
    if (_map.getView().getZoom() < 16.7) {
      // niveau de zoom où apparaissent les jeux (consultables). Attention, il faut changer cette valeur si le sld eux_enfants_vdr.sld change
