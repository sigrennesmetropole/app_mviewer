mviewer.customLayers.urbadiffus_en_chantier= (function() {
    ...
    let data_url="https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=urba_proj:v_oa_programme&outputFormat=application/json&srsName=EPSG:3857";
        ...
        source: new ol.source.Vector({
            ...
            loader: () => { // permet d'éviter le bug de features chargées en double 
                fetch(complete_url)
                    ...
                    .then(r => {
                        // nettoie la layer
                        mviewer.getLayer("urbadiffus_en_chantier").layer.getSource().clear();
                        // charge les features
