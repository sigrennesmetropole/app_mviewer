...
mviewer.customLayers.vergers = (function () {
  var data =
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=espub_esv:gev_verger_partage&outputFormat=application/json&srsName=EPSG:4326";
  /*
  ...
  customLayer.once("prerender", function () {
    ...
    features.forEach(function (feature) {
      let pointGeom = new ol.geom.Point(
