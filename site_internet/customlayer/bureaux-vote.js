mviewer.customLayers.bureauvote = (function () {
  let bureau_perim_url =
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=eq_educ:v_election_perim_bureau&outputFormat=application/json&srsName=EPSG:3857";

  var centres_data = new Map();

  getHttpData(
    "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=eq_educ:v_election_centre&CQL_FILTER=code_insee=35238&outputFormat=application/json",
  );
