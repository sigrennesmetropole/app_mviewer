const layer = new ol.layer.Vector({
  source: new ol.source.Vector({
    url: "https://public.sig.rennesmetropole.fr/geoserver/wfs?service=WFS&version=1.0.0&request=GetFeature&typeNames=trp_rout:v_geotravaux_evenement_06j&outputFormat=application/json&srsName=EPSG:4326",
  ...
  style: function (feature, resolution) {
    ...
    var date_deb_french =
      date_deb_split[2] + "/" + date_deb_split[1] + "/" + date_deb_split[0];
    var date_fin_french =
      date_fin_split[2] + "/" + date_fin_split[1] + "/" + date_fin_split[0];
